...
CREATE TABLE [PLAN] (
    ...
    UPDATE_DATE_TIME DATETIME,
    DELETE_FLAG BIT DEFAULT 0,
    PRIMARY KEY (PLAN_ID, TERM_ID),
    FOREIGN KEY (TERM_ID) REFERENCES TERM(TERM_ID)
);

-- PLAN_DETAIL Table
CREATE TABLE PLAN_DETAIL (
    PLAN_DETAIL_ID NVARCHAR(20) UNIQUE,
    PLAN_ID NVARCHAR(20),
...
CREATE TABLE MONTH_REPORT (
    MONTH_REPORT_ID NVARCHAR(20) UNIQUE,
    TERM_ID NVARCHAR(20),
    ...
    UPDATE_DATE_TIME DATETIME,
    DELETE_FLAG BIT DEFAULT 0,
    PRIMARY KEY (MONTH_REPORT_ID, TERM_ID),
    FOREIGN KEY (TERM_ID) REFERENCES TERM(TERM_ID)
);

-- MONTH_REPORT_DETAIL Table
CREATE TABLE MONTH_REPORT_DETAIL (
    MONTH_REPORT_DETAIL_ID NVARCHAR(20) UNIQUE,
    MONTH_REPORT_ID NVARCHAR(20),
    EXPENSE NVARCHAR(255),
    COST_TYPE INT,
    UNIT_PRICE DECIMAL(18,0),
    AMOUNT INT,
